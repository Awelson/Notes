---
title: "How I Learn Japanese (Part 1) : Background"
date: 2025-12-23
---

This is Part 1 of "How I Learn Japanese" :

- Part 1 : Background
- [Part 2 : Content](howilearnjapanese2.md)
...
!!! tip
    ...
    I guess what I am trying to say is that motivation is super important for learning new languages, so it might be helpful to think about **why** you want to be able to understand Japanese in the first place and focus on that as a goal instead, i.e. we want to make it so that learning Japanese becomes a means to an end. It is important that whatever goal you choose should **absolutely** require knowing Japanese to be achieved; something like "I want to be able to enjoy anime" is not ideal since you could always default to using translations to achieve that goal.

Obviously, this "workflow" will require you to know a bit of Japanese beforehand. At a minimum, you should aim towards already knowing about 30-40% of the vocabulary / grammar you will encounter for this to work without friction; in terms of JLPT levels, this probably amounts to somewhere between N4 and N3. The idea is : you want to be able to get to a point where you can, on your own, be able to at least understand the main plot of whatever it is you are watching or reading so that there is some form of enjoyment to be gained from the process. You can refer to some of the excellent guides I showcased in [an earlier note](japaneseguide.md) to help you get started to reaching this level. 

## What's Next? 

In the next part, I will be talking about how I source Japanese content to watch / read, as well as some of the tools I use to help streamline this process.
...
!!! note
    ...
    You can find more clips of VTubers (or anyone else really) by using `「VTuber」+ 切り抜き / 文字起こし / 手書き` as a search term on YouTube.  
...
- [【公式】PASH!  コミックス・ブックス・文庫](https://www.youtube.com/@pashup8195)
- [ゼロサムYouTubeチャンネル](https://www.youtube.com/@asaandumi)
...
!!! note
    ...
    I have been intentionally excluding BL content thus far (If it has not been clear, I am a fudanshi). This is because I kind of want all the BL content to be in a separate note, and its probably better that way since for some reason there is SOOO much BL content available so it would have just taken up a lot of space if I were to list them here. Whenever I am finished writing the BL note, I will include a link here so you can check it out if so inclined.
...
I will not bother stating which website/method I use to watch anime (it would change every few months anyway due to copyright), but you can refer to [wotaku.wiki](https://wotaku.wiki/) or any of the other sites listed [here](resourcesforotakus.md) for some ideas (both legal and illegal). I get JP subs from [jimaku.cc](https://jimaku.cc) and use [asbplayer](https://github.com/killergerbah/asbplayer) as a video player. It runs directly on the browser and makes subtitle text selectable, which is useful because you can pair it with a pop-up dictionary like [yomitan](https://yomitan.wiki/) to look up quickly look up definitions. 

### Manga

As with anime, I will not explicitly state how this can be sourced, but you can refer to the resources I have linked above. Once you have obtained your manga, you can use OCR tools like [mokuro](https://github.com/kha-white/mokuro) which allows you to read manga with selectable text inside a browser. Again, this is useful because you can pair it with [yomitan](https://yomitan.wiki/) to look up definitions easily.

I will further add that official websites like [cmoa.jp](https://www.cmoa.jp/) and [booklive](https://booklive.jp/) will sometimes provide free to read volumes (albeit for a limited time). You can then use [scripts](https://greasyfork.org/en/scripts/445038-cmoa-jp-downloader) to download the content so as to not worry about the time limit. 

## How do I "research" vocabulary/grammar?

Before getting started, I would highly recommended that you get [yomitan](https://yomitan.wiki/) and a [Japanese keyboard](https://www.google.co.jp/ime/) set up. It will take some time to get used to typing in Japanese, but [here](https://www.youtube.com/watch?v=MRtkiRchnF8) is a good video to get you started.

### Vocabulary

If you encounter a word you are not familiar with, the first step is to of course look up its definition. For most cases, yomitan will suffice. However, sometimes more work needs to be done. The two main problems that you will run into are :

- The word shows up in yomitan, but none of the listed definitions make sense given the context.
- The word does not show up in yomitan.

!!! note "Problem 1"

    It is possible that the word in question can be viewed as slang. For example, “toxic” traditionally means “poisonous”, but as a slang, it is used to describe an unhealthy or harmful personality, relationship, or environment. In Japanese, the word マグロ traditionally means "tuna", but it also has a more [adult meaning](https://ja.wikipedia.org/wiki/%E3%83%9E%E3%82%B0%E3%83%AD_(%E3%82%A2%E3%83%80%E3%83%AB%E3%83%88)): a person who is inactive during sexual intercourse. 
    
    While yomitan (or more specifically [jitendex](https://jitendex.org/)) is not blind to マグロ's alternative meaning, this behavior is not always guaranteed. In case yomitan fails, you can use [zokugo](http://search.zokugo-dict.com/) (basically [urban dictionary](https://www.urbandictionary.com/) but for Japanese). Alternatively, you can try adding 「スラング・俗語・通言・隠語」 to the end of your word before searching it up online.

!!! note "Problem 2"

    The two possibilites are: either the word in question is too obscure, or it is derived from pop culture, memes, etc... In either case, searching the word up online usually helps. For example, the word フェイファ gets brought up a lot in [The Apothecary Diaries](https://myanimelist.net/anime/54492/Kusuriya_no_Hitorigoto). The word didn't show up in any dictionaries, but an online search led to [this page](https://dic.pixiv.net/a/%E9%A3%9B%E7%99%BA) on the [pixiv encyclopedia](https://dic.pixiv.net/) which suggested that it was a made up word specific to the anime. 

    In general, the [pixiv encyclopedia](https://dic.pixiv.net/) is very useful for these more modern, pop culture type words. The YouTube channel [Scripting Japan](https://www.youtube.com/@scriptingjapan) is also a good resource to keep up with Japanese slang and pop culture, and there have been many instances where I was able to understand a joke in a video or a comment because I had watched a Scripting Japan video before hand. Alternatively, monolingual dictionaries (I use [weblio](https://www.weblio.jp/)) are generally more comprehensive compared to their bilingual counterparts and they may help with the more obscure words.

!!! tip

    How relevant is a word?

!!! tip

    If your word is fully in kanji, your search results will most likely be in Chinese. To mitigate this, you can attach 「とは」 at the end of your word before searching it up.

!!! tip

    It is a good idea to also look up related words (synonyms, antonyms, words that use the same kanji, etc..). For example, noticing the connection between 折る (to fold) and 折り紙 (origami) makes it almost impossible to forget the meaning of 折る. You can use [thesaurus.weblio.jp](https://thesaurus.weblio.jp/) for synonyms and antonyms,  

!!! tip

    When studying vocabulary, some people like to ignore English loan words. While this is fair to do for some words like アイスクリム (ice cream), there are loan words which, whilst retaining the original English meaning, have adopted a completely distinct pattern of usage. For example, the word アピール (appeal) is quite commonly used  
