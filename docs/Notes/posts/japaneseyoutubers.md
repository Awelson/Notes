---
title: "Japanese YouTubers I Watch"
date: 2025-12-28
---

Despite only understanding like half of what's going on, one of the reasons I continue to watch Japanese YouTube is to improve my Japanese. For that reason, I tend to watch channels that provide JP subtitles to help with the learning process. Hopefully the day will come where I can finally enjoy a video without having to open a dictionary every minute, but for now I have to keep practising. Below are some of the channels I particularly enjoy watching :

<!-- more -->

## VTubers

I usually watch VTubers from [nijisanji](https://www.nijisanji.jp/en). In particular, stuff from their [main channel](https://www.youtube.com/@nijisanji), [ChroNoiR](https://www.youtube.com/@ChroNoiR), [ROF-MAO](https://www.youtube.com/@ROFMAO), and [seitokai](https://www.youtube.com/@seitokai_07).
...
I also watch clips from these VTubers. They are much shorter compared to videos/streams, and are edited to include subs. Sometimes the clips include animations and drawings which make them more fun to watch. Below are some clip channels I often frequent :
...
The コント in アニメコント comes from the french word *conte* which translates to "tale" (as in story, fable, etc..) in English. アニメコント is therefore "animated tales", and it is a popular genre of video in Japan. The western equivalent to アニメコント would probably be something like "animated skits" (think videos/shorts by [Plan3](https://www.youtube.com/@Plan3), etc..) which is also very popular. 

Here are some of the ones I regularly watch :
...
- [コミックジーンチャンネル](https://www.youtube.com/@comicgene_ch)

ボイス漫画 doesn't necessarily have to be based on an actual published title. If someone wants to make content or tell a story with that style then they are free to do so, and this is exactly what [FermiLab](https://www.youtube.com/@ferumi) (also check out [here](https://www.youtube.com/@rin_lab) and [here](https://www.youtube.com/@fermi_lab)) did to create educational videos. 
...
This is just a place for YouTube content I watch that don't really fit into the previous categories :
